...
import { Shield, LayoutDashboard, Camera, Upload, Clipboard, Settings, Activity, Cloud, Sun, Moon, BookOpen, History, Lock, TerminalSquare, BarChart3, Mail } from 'lucide-react';
